Events.on(ContentInitEvent, e => {
  ...
  let props = {
    ...
    scale: 1,
    mag: 0.5,
    color1: Color.valueOf("#ffffffff"),
    color2: Color.valueOf("#000000ff"),
    colorOct: 1,
    colorPersi: 0.5,
    colorScale: 1,
    colorThres: 0.5
  ...
  props = {
    ...
    scale: 1,
    mag: 1,
    color1: Color.valueOf("#F0F0F0"),
    color2: Color.valueOf("#DCF2FF"),
    colorOct: 1,
    colorPersi: 1,
    colorScale: 1,
    colorThres: 0.5
  ...
  props = {
    ...
    scale: 1,
    mag: 0.5,
    color1: Color.valueOf("#878787"),
    color2: Color.valueOf("#6B6B6B"),
    colorOct: 1,
    colorPersi: 0.5,
    colorScale: 1,
    colorThres: 0.5
  ...
  props = {
    ...
    scale: 1,
    mag: 0,
    color1: Color.valueOf("#486ACD"),
    color2: Color.valueOf("#7090EA"),
    colorOct: 1,
    colorPersi: 0.5,
    colorScale: 1,
    colorThres: 0.5
  ...
  props = {
    ...
    scale: 0.75,
    mag: 1,
    color1: Color.valueOf("#42693A"),
    color2: Color.valueOf("#5F8A4A"),
    colorOct: 1,
    colorPersi: 0.5,
    colorScale: 1,
    colorThres: 0.5
  ...
  props = {
    ...
    scale: 1,
    mag: 0.5,
    color1: Color.valueOf("#F7CBA4"),
    color2: Color.valueOf("#D3AE8D"),
    colorOct: 1,
    colorPersi: 0.5,
    colorScale: 1,
    colorThres: 0.5
